...
_Computer vision engineer and researcher_ <br>
...
_**Works with:**_ `classic CV`, `VLMs`, `LLMs` <br>
...
_**Work with:**_ `python`, `pytorch`, `opencv`, `scikit-image`, `Pillow`,  `CNNs`, `Transformers`, `Segformer`, `Docker`
...
_**Work with:**_ `python`, `pytorch`, `pytorch-lightning`, `opencv`, `pillow`, `CNN`, `Transformers`, `django`, `vannila js`, `docker`<br>
_**Results:**_
  - Collected, preprocessed and annotated data for training (lots of videos)
  ...
  - Made experiments with EfficientNetV2 parameters, sizes and with different videos languages (russian and english)
  ...
  The current version of the project is a classification of spoken words..
